...
setxp        }
    ...
    */
    ...
    setKp(pKp) {
        this.param.kp = pKp;
        this.param.xp = pKp / (this.param.max - this.param.min);
    }
    ...
    setMax(pMax) {
        this.param.max = pMax;
        if (this.param.useXp) this.param.kp = (this.param.max - this.param.min) * this.param.xp;
    }
    ...
    update() {
        ...
        if (this.y > this.param.max) {
            this.sumErr = tn * ((this.param.max - this.param.off) / kp - e - tv * this.diffErr);
            this.y = this.param.max;
            this.lim = true;
        }
        if (this.y < this.param.min) {
            this.sumErr = tn * ((this.param.min - this.param.off) / kp - e - tv * this.diffErr);
